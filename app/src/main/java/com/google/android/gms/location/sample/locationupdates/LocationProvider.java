...
public class LocationProvider extends AppCompatActivity implements
    ...
    //Permissions at run time needed for older APIs
    ...
    public void startUpdatesButtonHandler(View view) {
        ...
        if (!mRequestingLocationUpdates) {
            ...
            /*
             * Starts the next activity on button click, after retrieving the last location
             * and stores the location in a bundle to pass forward the infomation
            */
            Intent intent = new Intent(OrderRequestActivity.ORDER_ACTION);
            intent.addCategory(OrderRequestActivity.ORDER_CATEGORY);
